...
export class TypeDeclaration {
  ...
  #matches(other) {
    ...
    if (s === o || o.kind === 'dyn' || o.kind === 'param') return true
...
class FunctionCandidates {
  ...
  add(declaration) {
    ...
    this.returnType =
      (this.returnType
        ? this.returnType.unify(this.registry, declaration.returnType)
        : declaration.returnType) || dynType

    this.declarations.push(declaration)
  }

  findMatch(argTypes, receiverType) {
