...
class LayeredMap {
  ...
  fork() {
    this.set = this.#throwLocked
    return new this.constructor(this)
  }

  #throwLocked() {
    throw new Error('Cannot modify locked LayeredMap')
  }
...
function createLayeredMap(source, MapCtor = LayeredMap) {
  if (source instanceof MapCtor) return source.fork()
...
export class Registry {
  ...
  constructor(opts = {}) {
    ...
    this.#typeDeclarations = createLayeredMap(opts.typeDeclarations || Object.entries(celTypes))
