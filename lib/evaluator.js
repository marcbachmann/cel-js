    ...
    '+'(ast, s) {
      ...
      switch (leftType) {
        ...
        case 'google.protobuf.Duration':
          if (rightType === 'google.protobuf.Duration') return left.addDuration(right)
          if (rightType === 'google.protobuf.Timestamp') return left.extendTimestamp(right)
          break
        case 'google.protobuf.Timestamp':
          if (rightType === 'google.protobuf.Duration') return right.extendTimestamp(left)
      }
    ...
    '-'(ast, s) {
      ...
      switch (leftType) {
        ...
        case 'double':
          ...
          break
        case 'google.protobuf.Duration':
          if (rightType === 'google.protobuf.Duration') return left.subtractDuration(right)
          break
        case 'google.protobuf.Timestamp':
          if (rightType === 'google.protobuf.Duration') return right.subtractTimestamp(left)
          break
      }
  ...
  __supportsRelationalOperator(ast) {
    ...
    switch (leftType) {
      ...
      case 'google.protobuf.Timestamp':
        ...
        break
      case 'google.protobuf.Duration':
        if (rightType === 'google.protobuf.Duration') return
        break
    }
