...
const env = new Environment({
  ...
  .registerVariable('intA', 'int')
  .registerVariable('intB', 'int')
  .registerVariable('stringA', 'string')
  .registerVariable('doubleA', 'double')
  .registerVariable('doubleB', 'double')
  .registerVariable('doubleC', 'double')
  .registerVariable('doubleD', 'double')
  .registerVariable('doubleE', 'double')
  .registerVariable('userMap', 'map<string, string>')
